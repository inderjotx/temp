...
exports.defaultGlobalLocation = exports.scrapeJobs = void 0;
...
async function scrapeJobs() {
    const responseRaw = await fetch(`https://api.greenhouse.io/v1/boards/discord/embed/offices`);
...
exports.defaultGlobalLocation = data_api_1.locationIds.us;
