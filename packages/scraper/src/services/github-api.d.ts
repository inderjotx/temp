...
export declare function createNewJobsDataPullRequest({ jobs, addedJobs, removedJobs, scrapingErrors, invalidLocations, }: CreateNewJobsDataPullRequestParams): Promise<import("@octokit/types").OctokitResponse<{
    url: string;
    id: number;
    node_id: string;
    html_url: string;
