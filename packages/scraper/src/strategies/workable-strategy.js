...
exports.getJobsFromWorkable = void 0;
async function getJobsFromWorkable(workableCompanyId) {
    const responseRaw = await fetch(`https://apply.workable.com/api/v3/accounts/${workableCompanyId}/jobs`, { method: "POST" });
...
exports.getJobsFromWorkable = getJobsFromWorkable;
